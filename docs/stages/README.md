...
| [2026-05-19-docs-and-secret-scan.md](./2026-05-19-docs-and-secret-scan.md) | applied | 文档分层清理、gitleaks 本地安装复验、Plugin secret slots、P1.8/P1.9/P2.2 后续收口与 request log 分区 / retention 证据。 |
