...
| [2026-05-19-docs-and-secret-scan.md](./2026-05-19-docs-and-secret-scan.md) | applied | 文档分层清理、gitleaks 本地安装复验、Plugin secret slots、P1.8 sandbox 与 WASM ABI 设计稿收口证据。 |
